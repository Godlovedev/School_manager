...
export default function Contribution() {
    ...
    return (
              <div className="flex h-screen bg-gray-100">
                ...
                <div className="w-1/3 bg-white border-r h-[630px] border-gray-300 overflow-y-auto p-4">
                <div className="flex">
                  ...
                  <h3 className="text-md font-semibold text-gray-700 mt-4 mb-2">Montant Total: {contributions?.cash_contributions[0].total_amount} FCFA</h3>
                  {contributions?.cash_contributions.slice(1).map((c: any) => (
                    ...
                    >
                      ...
                      <button onClick={() => {setTargetedContribution(c)}} className="ml-auto bg-orange-500 p-2 rounded-lg text-white font-bold">Voir</button>
                    </div>
                  ))}
                  ...
                  {contributions?.inkind_contributions.map((c: any) => (
                    ...
                    >
                      ...
                      onClick={() => {setTargetedContribution(c);
                       ...
                       className="ml-auto text-white bg-orange-500 p-2 rounded-lg font-bold">Voir</button>
                    </div>
                  ))}
                ...
                <div className="flex-1 bg-white p-8 overflow-y-auto shadow-lg rounded-lg max-w-4xl mx-auto">
                  {targetedContribution && 'amount' in targetedContribution ? (
                    <div className="space-y-8">
                      <h2 className="text-3xl font-extrabold text-orange-500 mb-6 border-b-2 border-orange-300 pb-2">
                    ...
                    <div className="space-y-8">
                      <h2 className="text-3xl font-extrabold text-green-600 mb-6 border-b-2 border-green-300 pb-2">
